...
public class ChatApp1 {
    ...
    public static void main(String[] args) {
        ...
        String choice = inputObject.nextLine().trim().toLowerCase();
   ...
   public void Registration (){
       ...
       do{
           ...
           if(isUserPasswordValid){  
               System.out.println("Your User Password Is Correct");
       }
           else{
       ...
       while(true){
          ...
          if(!password.equals(userPassword)){
           ...
           System.out.println("Error: No Account Registered Yet. Please Register.");
           return;
       }
